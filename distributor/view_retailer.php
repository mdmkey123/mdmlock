...
$distributor_id = $_SESSION['user_id']; // Use distributor_id from session
...
// Fetch retailer details based on distributor_id
$query = "SELECT a.*, 
          ...
          WHERE a.id = '$id' AND a.distributor_id = '$distributor_id'";
