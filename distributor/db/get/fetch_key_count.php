...
$role = $_GET['role']; // Role: super_distributor, retailer
$role_id = $_GET['role_id'];
$super_admin_id = $_GET['super_admin_id']; // Passed from frontend

// Define conditions for fetching key count, removing distributor system
$conditions = [
...
$query_keys = "SELECT COUNT(*) AS key_count FROM enrollment_keys 
