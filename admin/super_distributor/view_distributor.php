...
$super_distributor_id = $_SESSION['user_id']; // Get Super Distributor ID from session
...
$query = "SELECT d.*, 
          ...
          WHERE d.id = '$id' AND d.super_distributor_id = '$super_distributor_id'";
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p><strong>Delete:</strong> 
                                    <button class='status-btn inactive-status' onclick='deleteDistributor(<?= $row['id'] ?>)' title='Delete'>
                                        Delete
                                    </button>
                                </p>
                            </div>
