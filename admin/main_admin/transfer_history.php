...
// Filters
$whereClauses = ["second_user_type = 'main_admin'"];
$filters = [];
                            ...
                            <form method="GET">
                                <div class="row g-3">
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" name="transaction_id" class="form-control" value="<?= $filters['transaction_id'] ?? '' ?>">
                                    </div>
                                    <div class="col-md-3">
                                        <label>Type</label>
                    ...
                    <div class="card">
                        ...
                        <div class="table-container">
                            <table class="custom-table">
                                ...
                                <tbody>
                                    <?php
                                    $count = $offset + 1; // Correct row numbering
