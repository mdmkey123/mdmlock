                        ...
                        <div class="card-body">
                            ...
                            <form id="admin-form">
                                <div class="row">
                                    ...
                                    ?>
                                    <div><strong>Current FRP-Id: </strong><?php echo $data['frp_id']; ?> </div>
                                    <br>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label class="form-label">FRP-Id</label>
                                            <input type="text" class="form-control" name="frp_id" placeholder="Enter FRP-Id" required>
                                        </div>
