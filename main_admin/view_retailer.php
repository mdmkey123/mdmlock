...
$main_admin_id = $_SESSION['user_id']; // Use main_admin_id from session
...
$query = "SELECT a.*, 
          ...
          WHERE a.id = '$id' AND a.main_admin_id = '$main_admin_id'";
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p><strong>Balance:</strong> <i class="ri-key-fill"></i> <?= $row['balance'] ?></p>
                            ...
                            <p><strong>Delete:</strong> 
                                <button class='status-btn inactive-status' onclick='deleteRetailer(<?= $row['id'] ?>)' title='Delete'>
                                    Delete
                                </button>
                            </p>
                        </div>
