                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <?php
                                            $query_distributors = "SELECT id, unique_main_admin_id, name FROM main_admin WHERE super_admin_id = '$user_id'";
                                            $result_distributors = mysqli_query($conn, $query_distributors);
                                            ?>
                                            <select class="form-control" name="main_admin_id" id="main_admin_id">
                                                <option>Select Main Admin</option>
                                                <?php while ($row_distributor = mysqli_fetch_assoc($result_distributors)): ?>
                                                    <option value="<?php echo $row_distributor['id']; ?>">
                                                        <?php echo $row_distributor['unique_main_admin_id']; ?> -
                                                        <?php echo $row_distributor['name']; ?>
                                                    </option>
                                                <?php endwhile; ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label class="form-label">Super City</label>
